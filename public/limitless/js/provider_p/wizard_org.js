    ...
    var _componentWizard = function () {
        ...
        $('.steps-validation').steps({
            ...
            onFinished: function (event, currentIndex) {
                ...
                var clasificationsSelected = ""
                var accreditationSelected=""
                ...
                accreditations.each(function (index, $this) {
                    ...
                    if (accreditation.is(':checked')) {
                        accreditationSelected += accreditation.val() + ","
                    }
                })
                ...
                clasifications.each(function (index, $this) {
                    ...
                    if (clasification.is(':checked')) {
                        clasificationsSelected += clasification.val() + ","
                    }
                })
                ...
                $('#clasificationsSelected').val(clasificationsSelected)
                $('#accreditationSelected').val(accreditationSelected)
